<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="admincollegesuggestions.aspx.cs" Inherits="Student_Career_Counselling.adminbookissuing" %>
         ...
         <div class="col-md-5">
            <div class="card">
               <div class="card-body">
                  ...
                  <div class="row">
                     <div class="col-12">
                        <asp:Button ID="Button2" class="btn btn-lg btn-block btn-primary" runat="server" Text="Suggest" />
                     </div>
                  </div>
               </div>
            </div>
